 ...
 * Generated at: 2021-02-22 05:57:20 UTC
...
public final class userDel_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("          </div>\r\n");
      out.write("          <form class=\"joinForm\" action=\"\">\r\n");
      out.write("            <div class=\"form-group\">\r\n");
      out.write("            \t<input type=\"checkbox\" id=\"check\" name=\"check\"/>\r\n");
      out.write("            \t<label for=\"check\">개인정보 보유 및 이용 동의</label>\r\n");
      ...
      out.write("          \r\n");
      out.write("            <div class=\"form-group\">\r\n");
      out.write("              <label for=\"res\">떠나는 이유를 남겨주세요.</label>\r\n");
      out.write("              <div>\r\n");
      out.write("              \t<input class=\"form-control\" type=\"text\" name=\"res\" id=\"res\" placeholder=\"탈퇴사유를 입력해주세요.\" disabled style=\"width:310px; display:inline;\"/>\r\n");
      out.write("\t\t\t\t<select class=\"custom-select\" id=\"selectRes\" style=\"float:right; width:80px;\">\r\n");
      out.write("\t\t\t\t\t<option value=\"none\" selected>선택하기</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"res1\">더 이상 이용하지 않아요.</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"res2\">중복된 아이디가 있어요.</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"res3\">정보가 너무 부족해요.</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"res_self\">직접입력</option>\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("              </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            \r\n");
      ...
      out.write("              <input type=\"password\" id=\"userPW\" name=\"userPW\" class=\"form-control\" placeholder=\"비밀번호를 입력해주세요.\">\r\n");
      out.write("            </div>\r\n");
      out.write("            \r\n");
      out.write("            <br>\r\n");
      out.write("            <div class=\"text-center\">\r\n");
      out.write("            <button type=\"submit\" class=\"btn btn-primary\" style=\"width:100px; height:30px; margin:auto; margin-top:15px; font-size:13px;\">탈퇴하기</button>\r\n");
      out.write("          </div>\r\n");
      out.write("          </form>\r\n");
      out.write("        </main>\r\n");
      out.write("      </div>\r\n");
      ...
      out.write("    \t\t\tif($(this).val() == 'res_self'){\r\n");
      out.write("    \t\t\t\t$('#res').val('');\r\n");
      out.write("    \t\t\t\t$('#res').attr(\"disabled\",false);\r\n");
      out.write("    \t\t\t}else if($(this).val() == 'none'){\r\n");
      out.write("    \t\t\t\t$('#res').val('');\r\n");
      out.write("    \t\t\t\t$('#res').attr(\"disabled\",true);\r\n");
      out.write("    \t\t\t}\r\n");
      out.write("    \t\t\telse{\r\n");
      out.write("    \t\t\t\t$('#res').val($(this).text());\r\n");
      out.write("    \t\t\t\t$('#res').attr(\"disable\",true);\r\n");
      out.write("    \t\t\t}\r\n");
      out.write("    \t\t});\r\n");
      out.write("    \t});\r\n");
      out.write("    });\r\n");
