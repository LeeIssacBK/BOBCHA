...
<style>
  ...
  <body>
        <main class="login">
          ...
          <p>회원아이디와 가입시 등록한 이메일을 입력해주세요.<br>
          	이메일로 임시 비밀번호를 전송합니다.</p>
          <form method="post" action="/member/findPw_ok">
            <div class="form-group">
              <label for="id">아이디</label>
              <input type="text" id="m_id" name="m_id" class="form-control" placeholder="아이디를 입력해주세요.">
            </div>
            ...
            <button type="submit" class="btn btn-primary" id="findPwButton" style="width:100px; height:30px; font-size:13px;">전송</button>
            <br><br>
            <a href="" id="login2">로그인</a>&nbsp;|&nbsp;<a href="" id="findId">아이디 찾기</a>
            </div>
          </form>
        </main>
